...
<body>
    ...
    <head>
        ...
        <nav class="navbar navbar-default float-panel nav-mobile" role="navigation" data-top="0" data-scroll="300">
            <div class="container">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="{{url('')}}/index"><img src="{{url('public')}}/images/Logo.png" alt=""></a>
        ...
        <nav class="nav-second">
            <a href="" class="ns-active">Câu hỏi thường gặp</a>
            <a href="">Cửa hàng liên kết</a>
        </nav>
    </head>
    <main>
        <div class="container">
            <div class="row">
                <div class="col-sm-12 faq">
                    ...
                    <button class="accordion">Sản phẩm của Meup68 là gì?</button>
                    <div class="panel">
                        <p>Meup 68 có đa dạng các sản phẩm:
                            <br>- Vay trả góp
                            <br>- Vay tín chấp
                            <br>- Vay kinh doanh
                            <br>- Vay theo đăng ký xe
                        </p>
                    </div>
                    <h3>Về khoản vay</h3>
                    <button class="accordion">Ai có thể sử dụng sản phẩm?</button>
                    <div class="panel">
                        <p>Trường hợp quý khách vay online: từ đủ 19 - 29 tuổi.</p>
                        <p>Trường hợp quý khách vay tại quầy: từ đủ 18 - 60 tuổi.</p>
                        <p>Áp dụng trên toàn quốc.</p>
                    </div>
                    <button class="accordion">Lãi suất, phí là bao nhiêu?</button>
                    <div class="panel">
                        <p>Lãi suất cực ưu đãi, thấp hơn so với thị trường. Phụ thuộc vào từng trường hợp mà lãi suất có thể dao động, vì vậy xin vui lòng gọi 1900 0082 để được tư vấn cụ thể.</p>
                    </div>
                    <button class="accordion">Mất bao lâu để nhận được khoản tiền vay?</button>
                    <div class="panel">
                        <p>Chuyển khoản: trong vòng 1 giờ kể từ khi Meup 68 tiếp nhận được đầy đủ hồ sơ của quý khách.</p>
                        <p>Nhận tiền mặt: quý khách nhận tại quầy, trong vòng 4 giờ kể từ khi Meup 68 tiếp nhận được đầy đủ hồ sơ của quý khách.</p>
                    </div>
                    <button class="accordion">Làm sao để biết tôi đã được giải ngân hay chưa?</button>
                    <div class="panel">
                        <p>Quý khách sẽ nhận được tin nhắn thông báo từ Meup 68.</p>
                    </div>
                    <button class="accordion">Tôi cần chuẩn bị giấy tờ gì?</button>
                    <div class="panel">
                        <p>- Chứng minh nhân dân / Căn cước công dân.</p>
                        <p>- Sổ hộ khẩu / Bằng lái xe / Thẻ sinh viên (nếu là sinh viên).</p>
                    </div>
                    <h3>Thanh toán khoản vay</h3>
                    <button class="accordion">Tôi có thể thanh toán khoản vay ở đâu?</button>
                    <div class="panel">
                        <p>Quý khách có thể thanh toán trực tiếp tại quầy hoặc sử dụng ví điện tử Momo.</p>
                    </div>
                    <button class="accordion">Tôi cần chuẩn bị giấy tờ gì?</button>
                    <div class="panel">
                        <p>- Chứng minh nhân dân / Căn cước công dân.</p>
