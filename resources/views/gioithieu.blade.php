    ...
    <head>
        <div class="container">
            <nav class="nav-desktop">
                <div class="header-logo"><span class="helper"></span><a href="index"><img src="{{url('public')}}/images/logo.png" alt=""></a></div>
        ...
        <nav class="navbar navbar-default float-panel nav-mobile" role="navigation" data-top="0" data-scroll="300">
            <div class="container">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.html"><img src="{{url('public')}}/images/Logo.png" alt=""></a>
